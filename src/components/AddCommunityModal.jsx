...
const AddCommunityModal = ({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="project-creation-modal-overlay" onClick={onClose}>
          <motion.div
            initial={{ opacity: 0, scale: 0.95, y: 20 }}
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.95, y: 20 }}
            transition={{ duration: 0.2 }}
            className="project-creation-modal-container"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="project-creation-modal-header">
              ...
              <button
                ...
                className="project-creation-modal-close"
            ...
            {/* Body */}
            <div className="project-creation-modal-body">
